...
class SignOtpScreen extends GetView<SignUpOtpImplement> {
  const SignOtpScreen({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(SignUpOtpImplement());
    return CustomAuthPage(
        backButtonTitle: "Back",
        widget: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 15),
          child: GetBuilder<SignUpOtpImplement>(
            builder: (controller) => HandilingDataRequest(
              ...
              widget: Column(
                  ...
                  children: [
                    ...
                    GetBuilder<SignUpOtpImplement>(
                      builder: (cintroller) => RichText(
                        text: TextSpan(
                          text: '  Resend Code in  ',
                          style: Theme.of(context).textTheme.headline1,
                          children: <TextSpan>[
                    ...
                    GetBuilder<SignUpOtpImplement>(
                        builder: (cintroller) => CustomButton(
