...
List<String> seperatePhoneAndDialCode(String wholeNum) {
  Map<String, String> foundedCountry = {};
  for (var country in Countries.allCountries) {
    String dialCode = country["dial_code"].toString();
    if (wholeNum.contains(dialCode)) {
      foundedCountry = country;
    }
  }

  if (foundedCountry.isNotEmpty) {
    var dialCode = wholeNum.substring(
      0,
      foundedCountry["dial_code"]!.length,
    );
    var newPhoneNumber = wholeNum.substring(
      foundedCountry["dial_code"]!.length,
    );
    print({dialCode, newPhoneNumber});
    return ([dialCode, newPhoneNumber, foundedCountry["code"]!]);
  } else {
    return [];
  }
}
